...
module.exports = {
    createAccount, login, getProfile,
    // updatePassword, sendMoney, accountBalance, accountStatement, forgotPassword, getOtpForChangePassword, otpGenerate, deleteTransaction, paymentThroughDebitCard
}
